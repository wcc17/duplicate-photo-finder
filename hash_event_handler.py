...
class HashEventHandler(EventHandler):
    ...
    def handle_event(self, event, num_processed, process_num_processed_list, finished_process_count, total_to_process, process_list, image_models, skipped_files, append_to_be_skipped):
        ...
        self._write_progress_to_console(num_processed, total_to_process, process_num_processed_list, process_list, finished_process_count)
