...
class HashProcessor(BaseProcessor):
    ...
    def _setup_processes(self):
        ...
        for sub_list in self._sub_lists:
            ...
            process = HashWorker(process_id, self._event_queue, sub_list, self._use_verbose_logging, self._should_check_videos, process_connection)
    ...
    def _replace_process(self, process):
        ...
        new_process = HashWorker(process.process_id, self._event_queue, self._sub_lists[process.process_id-1], self._use_verbose_logging, self._should_check_videos, process_connection)
        return new_process