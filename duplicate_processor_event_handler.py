...
class DuplicateProcessorEventHandler(EventHandler):
    ...
    def handle_event(self, event, num_processed, process_num_processed_list, finished_process_count, total_to_process, process_list, known_duplicates, known_non_duplicates, skipped_files, single_folder_dupe_search):
        ...
        if event_type == EventType.DUPLICATE:
            ...
            process_num_processed_list[event_process_id-1].increment_num_processed()
            num_processed += 1
        ...
        self._write_progress_to_console(num_processed, total_to_process, process_num_processed_list, process_list, finished_process_count) # TODO: why is this in event_handler and not in BaseProcessor?
